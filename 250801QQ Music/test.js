...
// crypto.namee = 'crypto'
// crypto = proxy(crypto)
function proxy(obj){return new Proxy(obj, {
    get(target, p, receiver) {
        if(target.namee==undefined){debugger}
        console.log("查询操作:  ","对象: ", target.namee,"属性名:", p,);
        //console.log("查询操作:  ","对象: ", target.namee,"属性名:", p,' value::::',target[p]);
        return Reflect.get(target, p);
    },
    set(target, p, value, receiver) {
        if(target.namee==undefined){debugger}
        console.log("设置操作:  ","对象: ", target.namee, "属性名: ", p,)
       // console.log("设置操作:  ","对象: ", target.nameee, "属性名: ", p,"value: ", value)
        if(p=='_webmsxyw'){debugger;}
...
//////////////////////////////////////////////////////////
// navigator={namee:'navigator',vendorSub: '',userAgent:'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36 Edg/138.0.0.0',productSub: '20030107', vendor: 'Google Inc.',appVersion:"5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36 Edg/138.0.0.0"}
//
// navigator=new proxy(navigator)
/////////////////////////////////////////////////////////
// location= {   'namee':'location',
//     "ancestorOrigins": {},
...
////////////////////////////
// history={namee:'history'}
// history = new proxy(history)



////////////////////////////////
// HTMLCanvasElement={namee:'HTMLCanvasElement'}
//
// HTMLCanvasElement = new proxy(HTMLCanvasElement)

//////////////////////////////////////////
// screen = {namee:'screen'}
// screen = new proxy(screen)
//////////////////////////////////////////
// localStorage= {namee:"localStorage"}
//
...
var L = window.__cgiEncrypt
N = window.__cgiDecrypt;
a =
'{"comm":{"cv":4747474,"ct":24,"format":"json","inCharset":"utf-8","outCharset":"utf-8","notice":0,"platform":"yqq.json","needNewCode":1,"uin":0,"g_tk_new_20200303":5381,"g_tk":5381},"req_1":{"module":"musicToplist.ToplistInfoServer","method":"GetDetail","param":{"topid":5,"offset":0,"num":20,"period":"2025_32"}}}'
// L(a)
